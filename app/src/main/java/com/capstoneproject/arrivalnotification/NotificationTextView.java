 ...
 */
public class NotificationTextView extends android.support.v7.widget.AppCompatTextView {
    /**
     ...
     * presentation of text notifications. Make
     * sure to follow the
    ...
    public static void notify(final Context context,
        ...
        final String text = res.getString(
                R.string.text_notification_placeholder_text_template, exampleString);
